...
class EDTestCasePluginExecuteBioSaxsToSASv1_0(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCase = EDTestCasePluginExecuteBioSaxsToSASv1_0("EDTestCasePluginExecuteBioSaxsToSASv1_0")
    edTestCase.execute()
