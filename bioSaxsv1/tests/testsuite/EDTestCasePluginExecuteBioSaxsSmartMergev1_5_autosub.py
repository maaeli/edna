...
class EDTestCasePluginExecuteBioSaxsSmartMergev1_5_autosub(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginBioSaxsSmartMergev1_5")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBioSaxsSmartMergev1_5 = EDTestCasePluginExecuteBioSaxsSmartMergev1_5_autosub("EDTestCasePluginExecuteBioSaxsSmartMergev1_5_autosub")
    edTestCasePluginExecuteBioSaxsSmartMergev1_5.execute()
