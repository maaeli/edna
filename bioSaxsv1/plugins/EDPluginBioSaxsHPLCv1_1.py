...
class EDPluginBioSaxsHPLCv1_1(EDPluginControl):
    """
    ...
    * fix issue with timestamp. 
    ...
    def checkParameters(self):
        ...
        """
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.checkParameters")
    ...
    def preProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.preProcess")
        sdi = self.dataInput
...
#        self.xsDataResult.hplcFile = XSDataFile(XSDataString(hplc))
    ...
    def process(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.process")
    ...
    def postProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.postProcess")
    ...
    def doSuccessProcessOneFile(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.doSuccessProcessOneFile")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doSuccessProcessOneFile")
    ...
    def doFailureProcessOneFile(self, _edPlugin=None):
        ...
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doFailureProcessOneFile")
        if _edPlugin and _edPlugin.dataOutput and _edPlugin.dataOutput.status and  _edPlugin.dataOutput.status.executiveSummary:
            self.lstExecutiveSummary.append(_edPlugin.dataOutput.status.executiveSummary.value)
        else:
    ...
    def doSuccessDatop(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.doSuccessDatop")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doSuccessDatop")
    ...
    def doFailureDatop(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.doFailureDatop")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doFailureDatop")
    ...
    def doSuccessAutoRg(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.doSuccessAutoRg")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doSuccessAutoRg")
        if _edPlugin and _edPlugin.dataOutput and _edPlugin.dataOutput.status and  _edPlugin.dataOutput.status.executiveSummary:
            self.lstExecutiveSummary.append(_edPlugin.dataOutput.status.executiveSummary.value)
        try:
...
#             {'Vc': vc[0], 'dVc': vc[1], 'Qr': qr, 'dQr': dqr, 'mass': mass, 'dmass': dmass}
    ...
    def doFailureAutoRg(self, _edPlugin=None):
        ...
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doFailureAutoRg")
    ...
    def doSuccessDatCmp(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.doSuccessDatCmp")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doSuccessDatCmp")
        if _edPlugin and _edPlugin.dataOutput and _edPlugin.dataOutput.status and  _edPlugin.dataOutput.status.executiveSummary:
            self.lstExecutiveSummary.append(_edPlugin.dataOutput.status.executiveSummary.value)
    ...
    def doFailureDatCmp(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.doFailureDatCmp")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doFailureDatCmp")
        if _edPlugin and _edPlugin.dataOutput and _edPlugin.dataOutput.status and  _edPlugin.dataOutput.status.executiveSummary:
            self.lstExecutiveSummary.append(_edPlugin.dataOutput.status.executiveSummary.value)
        else:
    ...
    def doSuccessDatAver(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.doSuccessDatAver")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doSuccessDatAver")
    ...
    def doFailureDatAver(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsHPLCv1_1.doFailureDatAver")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsHPLCv1_1.doFailureDatAver")
        if _edPlugin and _edPlugin.dataOutput and _edPlugin.dataOutput.status and  _edPlugin.dataOutput.status.executiveSummary:
            self.lstExecutiveSummary.append(_edPlugin.dataOutput.status.executiveSummary.value)
        else:
