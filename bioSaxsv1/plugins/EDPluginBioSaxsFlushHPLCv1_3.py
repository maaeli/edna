...
#from EDPluginBioSaxsFlushHPLCv1_3 import EDPluginBioSaxsFlushHPLCv1_3 as EDPluginBioSaxsFlushHPLCv1_3
...
from EDPluginBioSaxsHPLCv1_3 import EDPluginBioSaxsHPLCv1_3


class EDPluginBioSaxsFlushHPLCv1_3 (EDPluginControl):
    """
    ...
    * adapt for version HPLC plugin v1.2
    ...
    def checkParameters(self):
        ...
        """
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.checkParameters")
        self.checkMandatoryParameters(self.dataInput, "Data Input is None")
        self.checkMandatoryParameters(self.dataInput.rawImage, "No raw image")

    def preProcess(self, _edObject=None):
        EDPluginControl.preProcess(self)
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.preProcess")
        sdi = self.dataInput
    ...
    def postProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.postProcess")
        ...
        for merge in run.merge_curves:
            if os.path.exists(merge):
                ...
                try:
                    ...
                    traceback.print_stack()
                    self.ERROR("EDPluginBioSaxsFlushHPLCv1_3 calling to EDPluginHPLCPrimayDataISPyBv1_0: %s" % error)
    ...
    def doSuccessDatAver(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.doSuccessDatAver")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsFlushHPLCv1_3.doSuccessDatAver")
    ...
    def doFailureDatAver(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.doFailureDatAver")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsFlushHPLCv1_3.doFailureDatAver")
    ...
    def doSuccessSaxsAnalysis(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.doSuccessSaxsAnalysis")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsFlushHPLCv1_3.doSuccessSaxsAnalysis")
        self.retrieveMessages(_edPlugin)
        run = EDPluginBioSaxsHPLCv1_3.dictHPLC[self.runId]
...
#         run.merge_xsDensityPlot[curvename] = _edPlugin.dataOutput.densityPlot
    ...
    def doFailureSaxsAnalysis(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.doFailureSaxsAnalysis")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsFlushHPLCv1_3.doFailureSaxsAnalysis")
        self.retrieveMessages(_edPlugin)
    ...
    def doSuccessSaxsToSAS(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.doSuccessSaxsToSAS")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsFlushHPLCv1_3.doSuccessSaxsToSAS")
        
    def doFailureSaxsToSAS(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.doFailureSaxsToSAS")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsFlushHPLCv1_3.doFailureSaxsToSAS")
        self.retrieveMessages(_edPlugin)
    ...
    def doSuccessISPyBAnalysis(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.doSuccessISPyBAnalysis")
        self.addExecutiveSummaryLine("Registered analysis in ISPyB")
        self.retrieveMessages(_edPlugin)

    def doFailureISPyBAnalysis(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsFlushHPLCv1_3.doFailureISPyBAnalysis")
