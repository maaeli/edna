...
class EDTestCasePluginExecuteControlSaxsModelingv1_1(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlSaxsModelingv1_1 = EDTestCasePluginExecuteControlSaxsModelingv1_1("EDTestCasePluginExecuteControlSaxsModelingv1_1")
    edTestCasePluginExecuteControlSaxsModelingv1_1.execute()
