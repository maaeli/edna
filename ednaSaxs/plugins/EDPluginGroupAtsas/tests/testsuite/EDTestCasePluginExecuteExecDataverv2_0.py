...
class EDTestCasePluginExecuteExecDataverv2_0(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin Dataverv2_0
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginExecDataverv2_0")
...
if __name__ == '__main__':
    ...
    testDataverv2_0instance = EDTestCasePluginExecuteControlDataverv2_0("EDTestCasePluginExecuteExecDataverv2_0")
    testDataverv2_0instance.execute()
