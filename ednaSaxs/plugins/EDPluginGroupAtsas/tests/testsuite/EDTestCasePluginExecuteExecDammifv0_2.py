...
class EDTestCasePluginExecuteExecDammifv0_2(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin Dammifv0_2
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginExecDammifv0_2")
...
if __name__ == '__main__':
    ...
    testDammifv0_2instance = EDTestCasePluginExecuteExecDammifv0_2("EDTestCasePluginExecuteExecDammifv0_2")
    testDammifv0_2instance.execute()
