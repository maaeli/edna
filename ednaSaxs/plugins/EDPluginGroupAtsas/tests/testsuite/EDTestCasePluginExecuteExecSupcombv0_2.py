...
class EDTestCasePluginExecuteExecSupcombv0_2(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin Supcombv0_2
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginExecSupcombv0_2")
...
if __name__ == '__main__':
    ...
    testSupcombv0_2instance = EDTestCasePluginExecuteExecSupcombv0_2("EDTestCasePluginExecuteExecSupcombv0_2")
    testSupcombv0_2instance.execute()
