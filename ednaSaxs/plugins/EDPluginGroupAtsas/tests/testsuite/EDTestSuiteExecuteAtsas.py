...
class EDTestSuiteExecuteAtsas(EDTestSuite):
    ...
    def process(self):
        tests = ['EDTestCasePluginExecuteExecDataverv2_0',
                 'EDTestCasePluginExecuteExecSupcombv0_1',
                 'EDTestCasePluginExecuteExecSupcombv0_3',
                 'EDTestCasePluginExecuteExecDamminv0_1',
                 'EDTestCasePluginExecuteExecDatopv2_0',
                 'EDTestCasePluginExecuteExecDatcmpv2_0',
                 'EDTestCasePluginExecuteExecAutoRgv1_0',
                 'EDTestCasePluginExecuteExecDamstartv0_3',
                 ...
                 'EDTestCasePluginExecuteExecDamfiltv0_3',
                 'EDTestCasePluginExecuteExecDammifv0_2',
                 'EDTestCasePluginExecuteExecDamminv0_2',
