...
class EDTestCasePluginExecuteExecDamstartv0_3(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin Damstartv0_3
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginExecDamstartv0_3")
...
if __name__ == '__main__':
    ...
    testDamstartv0_3instance = EDTestCasePluginExecuteExecDamstartv0_3("EDTestCasePluginExecuteExecDamstartv0_3")
    testDamstartv0_3instance.execute()
