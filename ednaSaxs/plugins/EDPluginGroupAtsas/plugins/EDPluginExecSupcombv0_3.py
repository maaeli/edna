...
class EDPluginExecSupcombv0_3(EDPluginExecProcessScript):
    ...
    def checkParameters(self):
        ...
        """
        self.DEBUG("EDPluginExecSupcombv0_3.checkParameters")
    ...
    def checkSupcombEnantiomorphsInput(self):
        self.DEBUG("EDPluginExecSupcombv0_3.checkEnantiomorphs")
    ...
    def checkSupcombBackboneInput(self):
        self.DEBUG("EDPluginExecSupcombv0_3.checkBackbone")
    ...
    def preProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginExecSupcombv0_3.preProcess")
    ...
    def generateSupcombScript(self):
        self.DEBUG("EDPluginExecSupcombv0_3.generateSupcombScript")
        ...
        commandLine = " --mode=FAST -o %s "%(self.__strOutputFileName)
        
        if self.__bBackbone:
            commandLine += " --superposition=BACKBONE "
        if not self.__bEnantiomorphs:
            commandLine += " --enantiomorphs=NO "
    
        commandLine += " template.pdb supimpose.pdb"               
