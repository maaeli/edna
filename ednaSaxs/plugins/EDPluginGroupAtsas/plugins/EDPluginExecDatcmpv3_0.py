...
class EDPluginExecDatcmpv3_0(EDPluginExecProcessScript):
    """
    ...
    def checkParameters(self):
        ...
        """
        self.DEBUG("EDPluginExecDatcmpv3_0.checkParameters")
    ...
    def postProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginExecDatcmpv3_0.postProcess")
    ...
    def generateDatcmpScript(self):
        self.DEBUG("EDPluginExecDatcmpv3_0.generateScript")
        self.setScriptCommandline("--test=CORMAP " + " ".join(self.listFiles[:2]))
